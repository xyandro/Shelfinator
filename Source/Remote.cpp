...
namespace Shelfinator
{
	...
	{
		static const char *lircNames[] = { "KEY_PLAY", "KEY_PAUSE", "KEY_REWIND", "KEY_FASTFORWARD", "KEY_ENTER", "KEY_NUMERIC_0", "KEY_NUMERIC_1", "KEY_NUMERIC_2", "KEY_NUMERIC_3", "KEY_NUMERIC_4", "KEY_NUMERIC_5", "KEY_NUMERIC_6", "KEY_NUMERIC_7", "KEY_NUMERIC_8", "KEY_NUMERIC_9" };
		static RemoteCode remoteCodes[] = { Play, Pause, Rewind, FastForward, Enter, D0, D1, D2, D3, D4, D5, D6, D7, D8, D9 };
