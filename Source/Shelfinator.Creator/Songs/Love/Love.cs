...
namespace Shelfinator.Creator.Songs
{
	class Love : ISong
	{
		...
		public Song Render()
		{
			...
			var header = new Layout("Shelfinator.Creator.Songs.Layout.Layout-Header.png");
			...
			var textI = new Layout("Shelfinator.Creator.Songs.Love.I.png");
			...
			var textLove = new Layout("Shelfinator.Creator.Songs.Love.Love.png");
			...
			var textPerson = new Layout("Shelfinator.Creator.Songs.Love.Benji.png");
			...
			var song = new Song();
			song.AddSegment(segment, 0, 5600);
			return song;
		}
	}
}
