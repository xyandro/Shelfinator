...
namespace Shelfinator.Creator.Songs
{
	class Smiley : ISong
	{
		...
		public Song Render()
		{
			...
			int[,] pixels;
			using (var stream = typeof(Plasma).Assembly.GetManifestResourceStream("Shelfinator.Creator.Songs.Layout.Smiley.png"))
			...
			var song = new Song();
			song.AddSegment(segment, 0, 360, 5000, 3);
			return song;
		}
