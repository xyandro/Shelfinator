...
namespace Shelfinator.Creator.Songs
{
	class Plasma : ISong
	{
		...
		public Song Render()
		{
			...
			using (var stream = typeof(Plasma).Assembly.GetManifestResourceStream("Shelfinator.Creator.Songs.Layout.Plasma.gif"))
			...
			var song = new Song();
			song.AddSegment(segment, 0, time, 5000, 5);
			return song;
		}
	}
}
