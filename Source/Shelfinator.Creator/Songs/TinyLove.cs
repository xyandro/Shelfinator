...
namespace Shelfinator.Creator.Songs
{
	class TinyLove : SongCreator
	{
		...
		Segment Heart()
		{
			...
			var lightColor = new LightColor(0, height, new List<int> { 0x001000, 0x000100 }, new List<int> { 0x000010, 0x000001 }, new List<int> { 0x100000, 0x101010, 0x100000, 0x101010, 0x100000 }, new List<int> { 0x100010, 0x001010, 0x100010, 0x001010, 0x100010 }, Helpers.Rainbow6);
