...
//		}
//
//		public int RenderGame(Song song, Segment segment, int numHunters, int numPlayers, int startTime)
//		{
...
//			}
//
//			song.AddSegment(segment, startTime, startTime + time, time * TimeMultiplier);
...
//			var startTime = 0;
//			startTime = RenderGame(song, segment, 1, 1, startTime);
//			startTime = RenderGame(song, segment, 1, 5, startTime);
//			startTime = RenderGame(song, segment, 2, 32, startTime);
//			startTime = RenderGame(song, segment, 8, 256, startTime);
//			return song;
//		}
//	}
//}
